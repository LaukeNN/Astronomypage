            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {photos.map((photo, index) => (
                        ...
                        >
                            <img src={photo.src || photo.image} alt={photo.alt || "Imagen de galería"} className="w-full h-full object-cover aspect-square md:aspect-auto" />
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="text-white font-semibold text-sm">{photo.alt || "Sin título"}</span>
                            </div>
                        </motion.div>
                    ))}
                </div>
